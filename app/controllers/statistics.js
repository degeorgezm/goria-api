...
function processOrders(req, object, orders, done) {
    ...
    object['total_return_sales'] = parseFloat(parseFloat(return_sales).toFixed(2));
    object['total_net_sales'] = parseFloat(parseFloat(total_sales - return_sales).toFixed(2));
...
function processDailyOrders(req, object, orders, done) {
    ...
    object['daily_return_sales'] = parseFloat(parseFloat(return_sales).toFixed(2));
    object['daily_net_sales'] = parseFloat(parseFloat(total_sales - return_sales).toFixed(2));
