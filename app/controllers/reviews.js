...
exports.retrieve_reviews = function (req, res) {
    ...
    Review.find(query)
        .deepPopulate('user user.image product product.type product.groups product.departments product.sizes product.variants product.brands product.image product.images product.user product.user.image product.stock.variant')
