...
const ROLES = ['Default Admin', 'Owner', 'Admin', 'Supervisor', 'Employee', 'Temporary Employee', 'Intern'];
...
var User = new Schema({
    ...
    billingAddress: { type: Schema.Types.ObjectId, ref: 'Address', required: false },
    shippingAddress: { type: Schema.Types.ObjectId, ref: 'Address', required: false },
