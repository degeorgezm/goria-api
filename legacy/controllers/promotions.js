...
function retrievePromotion(req, done) {
  ...
  Promotion.findOne(query).exec(function (err, promotion) {
    if (err) {
...
exports.retrieve_all = function (req, res) {
  ...
  Promotion.find(query, projection)
    .sort("_updatedDate")
...
exports.retrieve = function (req, res) {
  ...
  Promotion.findOne(query, projection)
    .deepPopulate("brands departments types variants groups")
...
exports.update = function (req, res) {
  ...
  Promotion.update(query, req.body).exec(function (err, result) {
    if (err) {
      return res.status(500).send(err);
    } else {
...
exports.get_products = function (req, res) {
  ...
  async.waterfall(
    [async.apply(retrievePromotion, req), retrieveProducts],
